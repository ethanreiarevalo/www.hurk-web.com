        ...
        <div class="side-bar col-xl-3 col-lg-4 mb-5">
            ...
            <div class="content col-xl-9 col-lg-8 overflow-hidden">
                <div class="container">
                    ...
                    <?php
                    $reports_table_sql = "Select leaverequest.leaverequestEmployeeName, leaverequest.emp_supervisor_response, leaverequest.leaverequestType, leaverequest.emp_supervisor_remarks, tbl_emp_info.emp_id, CONCAT(tbl_emp_info.first_name,' ', tbl_emp_info.last_name) as emp_name from leaverequest INNER JOIN tbl_emp_info ON leaverequest.emp_supervisor = tbl_emp_info.emp_id where leaverequest.emp_supervisor_response <> 'Pending'";
